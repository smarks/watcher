...
class TwilioNotifier:
    ...
    def send_notification(self, url: str, message: str, subject: Optional[str] = None) -> bool:
        ...
        try:
            ...
            message = self.client.messages.create(
                body=sms_body, from_=self.from_phone, to=self.to_phone
            )
    ...
    def test_notification(self) -> Dict[str, Any]:
        ...
        try:
            ...
            message = self.client.messages.create(
                body=test_message, from_=self.from_phone, to=self.to_phone
            )
            ...
            return {"success": False, "message": "Twilio API error", "error": str(e)}
        except Exception as e:
            return {"success": False, "message": "Failed to send test SMS", "error": str(e)}
